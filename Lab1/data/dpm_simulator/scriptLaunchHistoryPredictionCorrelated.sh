...
for t in ${Tto_idle_case1[@]}; do
  eval "./scriptHistoryPredictionCorrelated.sh 1 $t"
done

#case 2
for t in ${Tto_idle_case2[@]}; do
  eval "./scriptHistoryPredictionCorrelated.sh 2 $t"
done

#case 3
for t in ${Tto_idle_case3[@]}; do
  eval "./scriptHistoryPredictionCorrelated.sh 3 $t"
done

#case 4
for t in ${Tto_idle_case4[@]}; do
  eval "./scriptHistoryPredictionCorrelated.sh 4 $t"
done

#case 5
for t in ${Tto_idle_case5[@]}; do
  eval "./scriptHistoryPredictionCorrelated.sh 5 $t"
done
