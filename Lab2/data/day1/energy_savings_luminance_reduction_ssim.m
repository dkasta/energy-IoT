function energy_savings_luminance_reduction_ssim(collection_power_savings, collection_distances)
        ...
        for i_image = 1:NUM_IMAGES
            ...
            ylabel('Euclidean distance %');
                ...
                saveas(gcf, "./results/luminance_reduction/img" + int2str(i_image) + "/" + "energy_savings_ssim.bmp");
        end 
