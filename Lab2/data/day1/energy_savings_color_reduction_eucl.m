function energy_savings_color_reduction_eucl(collection_power_savings, collection_distances)
        ...
        for i_image = 1:NUM_IMAGES
            ...
            saveas(gcf, "./results/color_reduction/img" + int2str(i_image) + "/" + "energy_savings_eucl.bmp");
