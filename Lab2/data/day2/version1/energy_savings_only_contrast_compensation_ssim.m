function energy_savings_only_contrast_compensation_ssim(collection_power_savings, collection_distances)
    ...
    for i_image = 1:NUM_IMAGES
        ...
        saveas(gcf, "./results/contrast_compensation/img" + int2str(i_image) + "/" + "energy_vs_ssim.jpg");
