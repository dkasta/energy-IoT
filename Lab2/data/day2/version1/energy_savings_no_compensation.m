function energy_savings_no_compensation(collection_power_savings, original_power, vector_Vdd)
    ...
    for i = 1:NUM_IMAGES
        ...
        saveas(gcf, "./results/no_compensation/img" + int2str(i) + "/" + "energy_vs_Vdd_scaling.jpg");
