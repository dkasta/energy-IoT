...
for iterations = 1 : NUM_ITERATIONS
    ...
    for i = 1 : NUM_IMAGES
        ...
        brighter_original_image{i} = apply_image_compensation(original_images{i}, luminance_loss{i}, 0);
        ...
        higher_contrast_original_image{i} = apply_image_compensation(original_images{i}, luminance_loss{i}, 1);
        ...
        higher_contrast_brightness_original_image{i} = apply_image_compensation(original_images{i}, luminance_loss{i}, 2);
    ...
    % Collections that gather all power and distorsion stats of all the
    % images
