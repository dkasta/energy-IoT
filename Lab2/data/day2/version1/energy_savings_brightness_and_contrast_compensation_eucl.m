function energy_savings_brightness_and_contrast_compensation_eucl(collection_power_savings, collection_distances)
    ...
    for i_image = 1:NUM_IMAGES
        ...
        saveas(gcf, "./results/brigntess_and_contrast_compensation/img" + int2str(i_image) + "/" + "energy_vs_eucl.jpg");
