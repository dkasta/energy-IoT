function energy_savings_only_brightness_compensation_ssim(collection_power_savings, collection_distances)
    ...
    for i_image = 1:NUM_IMAGES
        ...
        title(['Image #' int2str(i_image+218) ' - Energy savings and distorsion with SSIM']);
        ylabel('SSIM %');

        saveas(gcf, "./results/brightness_compensation/img" + int2str(i_image) + "/" + "energy_vs_ssim.jpg");
