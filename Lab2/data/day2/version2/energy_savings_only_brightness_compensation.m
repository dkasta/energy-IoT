function energy_savings_only_brightness_compensation(collection_power_savings, original_power, vector_Vdd)
    ...
    for iterations = 1:NUM_ITERATIONS
     ...
     for i = 1:NUM_IMAGES
        ...
        grid on
        saveas(gcf, "./results/brightness_compensation/img" + num2str(i) + "/" + "energy_vs_Vdd_scaling.jpg");
