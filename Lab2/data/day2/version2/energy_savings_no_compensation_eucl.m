function energy_savings_no_compensation_eucl(collection_power_savings, collection_distances)
        ...
        for i_image = 1:NUM_IMAGES
            ...
            saveas(gcf, "./results/no_compensation/img" + int2str(i_image) + "/"  + "energy_vs_eucl.jpg");
