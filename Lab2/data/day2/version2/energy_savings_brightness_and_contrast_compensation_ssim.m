function energy_savings_brightness_and_contrast_compensation_ssim(collection_power_savings, collection_distances)
    ...
    set(0,'DefaultFigureVisible','off')
        ...
        for i_image = 1:NUM_IMAGES
            ...
            title(['Image #' int2str(i_image) ' - Energy savings and distorsion with SSIM']);

            ylabel('SSIM %');

            
            saveas(gcf, "./results/brigntess_and_contrast_compensation/img" + int2str(i_image) + "/" + "energy_vs_ssim.jpg");
